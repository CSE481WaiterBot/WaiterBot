...
if("TRUE" STREQUAL "TRUE")
  set(randomwalker_SOURCE_PREFIX /home/cse/Documents/logoshi/catkin_ws/src/randomwalker)
  set(randomwalker_DEVEL_PREFIX /home/cse/Documents/logoshi/catkin_ws/devel)
  ...
  set(randomwalker_INSTALL_PREFIX /home/cse/Documents/logoshi/catkin_ws/install)
...
if(NOT "/home/cse/Documents/logoshi/catkin_ws/devel/include " STREQUAL " ")
  set(randomwalker_INCLUDE_DIRS "")
  set(_include_dirs "/home/cse/Documents/logoshi/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'randomwalker' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'jstn <jstn@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'randomwalker' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cse/Documents/logoshi/catkin_ws/src/randomwalker/${idir}'.  Ask the maintainer 'jstn <jstn@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cse/Documents/logoshi/catkin_ws/devel/lib;/home/cse/Documents/logoshi/catkin_ws/devel/lib;/opt/ros/indigo/lib)
...
set(randomwalker_EXPORTED_TARGETS "randomwalker_generate_messages_cpp;randomwalker_generate_messages_lisp;randomwalker_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${randomwalker_dep}_FOUND)
      find_package(${randomwalker_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${randomwalker_dep} REQUIRED ${depend_list})
  endif()
